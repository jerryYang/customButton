 ...
 */
public class RapidSwipeView extends View {
  ...
  private String mTitle = "rapid swipe";
  private float textLen = 0;

    public RapidSwipeView( Context context ) {
        super(context);
        init(null, 0);
    }

    public RapidSwipeView( Context context, AttributeSet attrs ) {
        super(context, attrs);
        init(attrs, 0);
    }

    public RapidSwipeView( Context context, AttributeSet attrs, int defStyle ) {
    ...
    private void updatePoints(){
      ...
      controlPoints.set( 9, cp10 );
      controlPoints.set( 10, cp11 );
  ...
  private Path drawCurve(ArrayList<Point> points, ArrayList<Point> controlPoints) {
    ...
    protected void onDraw(Canvas canvas) {
      ...
      int screenWidth = DeviceUtils.getScreenWidth( getContext() );
      canvas.drawText( mTitle, (screenWidth - textLen) / 2 , (points.get( 2 ).y + points.get( 5 ).y) / 2, mTextPaint);
    }
